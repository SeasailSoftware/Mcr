...
namespace ReagentStripTest
{
    class Options
    {
        public Options()
        {
            Culture = "zh-CN";
            Theme = "Light.Green";
            ReflectanceFactors = new double[31];
            for (var index = 0; index < 31; index++)
            {
                ReflectanceFactors[index] = 1.0;
            }
        }
        public string Theme { get; set; }
        public string Culture { get; set; } = "zh-CN";
        public string RawDataPath { get; set; } = $@"{Environment.CurrentDirectory}\Datas\Reports";
        public string ReportDataPath { get; set; } = $@"{Environment.CurrentDirectory}\Datas\RawDatas";

        public int ReportNumber { get; set; }
        public int ReportExpirationDate { get; set; } = 12;
        public StandardIlluminant Illuminant { get; set; } = StandardIlluminant.D65;
        public StandardObserver Observer { get; set; } = StandardObserver.CIE1964;
        public string SensorCoeffFilePath { get; set; }
        public string WhiteboardFilePath { get; set; }

        public int DataChannel { get; set; }

        public double[] ReflectanceFactors { get; set; }

        public SparkleStandard SparkleStandard { get; set; } = new SparkleStandard();
        public ConnectionWay ConnectionWay { get; set; } = ConnectionWay.ByUsb;
        public double Lower { get; set; }
        public double Upper { get; set; }
        public string SavePath { get; set; }
        public int SpecifiedWaveLength { get; set; } = 560;
        public int MeasurementDuration { get; set; } = 180;
        public int MeasurementInterval { get; set; } = 5000;
