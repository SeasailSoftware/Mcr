...
using ReagentStripTest;
using ReagentStripTest.ViewModels.Dialogs;
using MahApps.Metro.Controls;
using MahApps.Metro.Controls.Dialogs;
using ThreeNH.i18N;
using ProgressDialogController = ReagentStripTest.ViewModels.Dialogs.ProgressDialogController;
